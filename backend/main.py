...
from backend.routers import auth, departments, employees, tasks, notifications, comments, kpi, ai, tro_ly
...
app.include_router(tro_ly.router, prefix="/api/tro-ly", tags=["tro-ly"])
